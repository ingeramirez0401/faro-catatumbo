...
This repository contains the code of the course [Angular Universal In Depth](https://angular-university.io/course/faro-web).

This course repository is updated to Angular v11.

![Angular Universal In Depth](https://angular-university.s3-us-west-1.amazonaws.com/course-images/faro-web.jpg)
...
We can install the master branch using the following commands:
    ...
    git clone https://github.com/angular-university/faro-web.git
...
If you are looking for the [Angular Universal Course](https://angular-university.io/course/faro-web), the repo with the full code can be found here:
